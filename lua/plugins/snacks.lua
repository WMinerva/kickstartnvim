...
return {
    ...
    keys = {
        ...
        { "<leader>h", function() Snacks.notifier.show_history(opts) end, desc = "Show Notification" },
        {
            "<leader>e",
            function()
        ...
        { "<leader>ff", function() Snacks.picker.files({ cwd = vim.fn.expand("%:p:h") }) end, desc = "Find Files" },
        { "<leader>fg", function() Snacks.picker.git_files() end, desc = "Find Git Files" },
        { "<leader>fp", function() Snacks.picker.projects({ projects = my_projects, recent = false }) end, desc = "Projects" },
        { "<leader>fr", function() Snacks.picker.recent() end, desc = "Recent" },
        -- git
        { "<leader>gt", function() Snacks.git.blame_line() end, desc = "Git Blame" },
